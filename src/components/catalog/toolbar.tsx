      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          ...
          {searchQuery ? (
            <p className="text-sm text-base-content/60">
              ...
              {" for "}
              <span className="font-medium text-base-content">"{searchQuery}"</span>
              {activeFilterCount > 0 && (
        ...
        <div className="flex items-center gap-3">
          <div className="hidden items-center gap-1 sm:flex">
            <span className="btn btn-ghost btn-sm btn-square bg-base-200" aria-label="Grid view">
            ...
            <span className="btn btn-ghost btn-sm btn-square" aria-label="List view">
              <svg className="size-4" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
